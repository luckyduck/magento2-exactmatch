...
namespace Luckyduck\ExactMatchSearch\Search\Adapter\Mysql\Query\Builder;

use Magento\Framework\DB\Helper\Mysql\Fulltext;
use Magento\Framework\DB\Select;
use Magento\Framework\Search\Adapter\Mysql\Field\FieldInterface;
use Magento\Framework\Search\Adapter\Mysql\Field\ResolverInterface;
use Magento\Framework\Search\Adapter\Mysql\Query\Builder\Match as OrigMatch;
use Magento\Framework\Search\Adapter\Mysql\ScoreBuilder;
use Magento\Framework\Search\Adapter\Preprocessor\PreprocessorInterface;
use Magento\Framework\Search\Request\QueryInterface as RequestQueryInterface;

class Match extends OrigMatch
{
    /**
     * @var string
     */
    ...
    protected function prepareQuery($queryValue, $conditionType)
    {
        ...
        // "xyz abc" matches only when a hit contains this exact string
        return sprintf('"%s"', $queryValue);
    }
}
